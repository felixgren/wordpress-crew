...
function FontSizePicker({
  ...
  const selectedOption = (_fontSizes$find = fontSizes.find(option => option.size === selectedValue)) !== null && _fontSizes$find !== void 0 ? _fontSizes$find : {
    name: 'Custom'
  };
  ...
  return (0, _element.createElement)(_components.BottomSheet.SubSheet, {
    navigationButton: (0, _element.createElement)(_components.BottomSheet.Cell, {
      ...
      (0, _i18n.__)('%1$s (%2$s)'), selectedOption.name, selectedValue) : (0, _i18n.__)('Default'),
    ...
    return (0, _element.createElement)(_components.BottomSheet.Cell, {
      ...
      key: index,
      accessibilityRole: 'button',
      accessibilityLabel: item.size === selectedValue ? (0, _i18n.sprintf)( // translators: %s: Select font size option value e.g: "Selected: Large".
      (0, _i18n.__)('Selected: %s'), item.name) : item.name,
      accessibilityHint: (0, _i18n.__)('Double tap to select font size')
    }, (0, _element.createElement)(_reactNative.View, null, item.size === selectedValue && (0, _element.createElement)(_icons.Icon, {
      icon: _icons.check
    })));
